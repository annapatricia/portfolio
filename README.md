# Anna Manrique — Computational Social Scientist & Data Scientist

I develop data-driven research and applied AI solutions focused on social phenomena and public policy.

My work integrates:
- Causal Inference & Econometrics
- Network Science & Opinion Dynamics
- Spatial & Geopolitical Analytics (GIS)
- Applied AI & Machine Learning
- Policy Analytics & Governance Systems
...
- **Accounting Assurance Monitor (AWS)** — Cloud-ready governance and compliance analytics pipeline.  
  🔗 https://github.com/annapatricia/accounting-assurance-monitor

- **People Analytics KPI** — Institutional performance monitoring and compliance analytics framework.  
